...
- chạy câu lệnh: `yarn create vite`
- Sau khi chạy xong cần chạy lệnh `yarn` để cài node_module

## Config môi trường

- Config post 3000 trong file `vite.config.ts`
...
- Bọc <App /> trong <BrowserRouter /> file `main.tsx`
